...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260502184839_AddBookingsAndAppSettings'
)
BEGIN
...
BEGIN
    CREATE UNIQUE INDEX [IX_Bookings_TicketNumber] ON [Bookings] ([TicketNumber]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260502184839_AddBookingsAndAppSettings', N'8.0.11');
END;
GO
