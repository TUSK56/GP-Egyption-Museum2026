...
export default function BookTourPage() {
  ...
  const totalDuration = selectedLocations.reduce((total, loc) => total + loc.duration, 0);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {isBooked ? (
          ...
          <motion.div 
            ...
            className="max-w-2xl mx-auto bg-gradient-to-b from-[#111] to-[#0a0a0a] border border-[#D4AF37] rounded-[3rem] p-10 text-center relative overflow-hidden shadow-[0_0_50px_rgba(212,175,55,0.2)]"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-[#111] p-4 rounded-2xl border border-white/5">
                    ...
                    <input 
                      ...
                      className="w-full bg-transparent text-white text-lg outline-none cursor-pointer [color-scheme:dark]"
                    />
                  </div>
                  <div className="bg-[#111] p-4 rounded-2xl border border-white/5">
            ...
            <div className="lg:col-span-4 relative">
              <div className="sticky top-32 bg-[#111] border border-white/10 rounded-[2rem] p-8 shadow-2xl">
