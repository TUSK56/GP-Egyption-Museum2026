...
import { Download, FileText, TrendingUp, Calendar, Filter, Share2, BarChart3, PieChart as PieChartIcon } from "lucide-react";
import { 
  BarChart, Bar, LineChart, Line, XAxis, YAxis, 
  CartesianGrid, Tooltip, ResponsiveContainer, AreaChart, Area 
} from "recharts";

// --- بيانات التحليلات الشهرية ---
const monthlyData = [
  { month: "Jan", artifacts: 142, users: 2340, views: 12450 },
  { month: "Feb", artifacts: 189, users: 2890, views: 15230 },
  { month: "Mar", artifacts: 234, users: 3420, views: 18670 },
  { month: "Apr", artifacts: 198, users: 3150, views: 16890 },
  { month: "May", artifacts: 267, users: 4120, views: 21340 },
  { month: "Jun", artifacts: 289, users: 4580, views: 24560 },
];

const reports = [
  { id: 1, name: "Monthly Visitor Report", description: "Comprehensive visitor analytics for June 2026", date: "2026-03-01", type: "Analytics" },
  { id: 2, name: "Artifact Inventory Report", description: "Complete inventory of all museum artifacts", date: "2026-03-01", type: "Inventory" },
  { id: 3, name: "User Engagement Report", description: "User interaction and engagement metrics", date: "2026-02-28", type: "Analytics" },
  { id: 4, name: "3D Model Performance", description: "3D model load times and viewer statistics", date: "2026-02-25", type: "Performance" },
];
    ...
    <div className="p-8 space-y-10 min-h-screen pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          <button className="flex items-center gap-2 px-6 py-3 bg-white/5 border border-white/10 text-white rounded-xl hover:bg-white/10 transition-all font-bold text-xs uppercase tracking-widest">
            <Filter size={16} /> Filter Data
          </button>
          <button className="flex items-center gap-2 px-6 py-3 bg-[#D4AF37] text-black rounded-xl hover:bg-[#b5952f] transition-all font-black text-xs uppercase tracking-widest shadow-[0_10px_20px_rgba(212,175,55,0.2)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          { label: "Institutional Growth", value: "+23.5%", icon: TrendingUp, color: "text-emerald-500", desc: "Performance vs Last Quarter" },
          { label: "Archived Dossiers", value: "147", icon: BarChart3, color: "text-[#D4AF37]", desc: "Stored Intelligence Reports" },
          { label: "Latest Compilation", value: "Today", icon: Calendar, color: "text-blue-500", desc: "Last Automated Sync" },
        ].map((stat, i) => (
          <motion.div 
          ...
          {reports.map((report, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-8">
                ...
                <button className="flex items-center gap-3 px-6 py-3 bg-white/5 border border-white/10 text-white rounded-xl group-hover:bg-[#D4AF37] group-hover:text-black transition-all font-black text-[10px] uppercase tracking-widest active:scale-95">
